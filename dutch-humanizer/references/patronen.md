...
Doorloop deze lijst niet mechanisch. Gebruik haar om een patroon te herkennen of een nuance op te zoeken nadat je in de tekst je drie dominante tells hebt geïdentificeerd.
...
**Signaalwoorden:** bruisend, adembenemend, betoverend, baanbrekend, gelegen in het hart van, sfeervol, toonaangevend, niet te missen, iconisch, must-see.
...
Drie correcte aanpakken:

1. **Verwijder de bronclaim** als de uitspraak ook zonder bron staat:
...
2. **Markeer voor de gebruiker** als de claim afhangt van de bron:
   - **Voor:** "Onderzoek wijst uit dat 60% van de Nederlanders X doet."
   - **Na:** "Volgens [bron?] doet 60% van de Nederlanders X."
3. **Behoud een specifieke bron als die al in de input stond.**

**Verzin nooit** een organisatie, jaartal, percentage of citaat om "experts zeggen" concreter te maken. Dat is hallucinatie, niet humanisering.
...
**Hoogfrequent:** daarnaast, essentieel, cruciaal, aanzienlijk, een breed scala aan, naadloos, robuust, faciliteren, optimaliseren, dynamisch, innovatief, landschap (abstract), alomvattend, breed gedragen, van onschatbare waarde, waarborgen, ontsluiten, hervormen, transformeren.
...
**Signaalwoorden:** fungeert als, dient als, vormt een, kenmerkt zich door, beschikt over, manifesteert zich als.
...
### 13. Passief en subjectloze zinnen
...
Nederlands gebruikt sentence case. Alleen de eerste letter en eigennamen krijgen een hoofdletter.
...
Verwijder uit lopende tekst en uit lijst-bullets. Uitzondering: socials waar emoji's bewust deel van het register zijn (zelfs daar geldt: zelden, niet als visuele opsmuk).

### 19. Gekrulde aanhalingstekens

Vervang `"..."` (curly) door rechte `"..."`. AI gebruikt vaak smart quotes waar de bron-tekst rechte gebruikte.

---

## Communicatie

### 20. Assistent-tics (chatbot-artefacten + slijmerige toon)

**Signaalwoorden:** Goede vraag!, Uitstekende vraag!, Zeker!, Natuurlijk!, Ik hoop dat dit helpt!, Laat me weten als..., Je hebt helemaal gelijk dat..., Wat een interessant onderwerp!, Voel je vrij om...
...
**Na (als de info beschikbaar is):** "Het bedrijf is opgericht in 1994."
**Na (als niet):** "Het oprichtingsjaar staat niet in de aangeleverde bronnen." *(Niet gokken.)*
...
### 24. Generieke positieve conclusies
...
### 25. Retorische autoriteitsfrases

**Signaalwoorden:** de kern is, waar het werkelijk om gaat, fundamenteel gezien, in werkelijkheid, in essentie.
...
### 26. Aankondigingen en wegwijzers

**Signaalwoorden:** laten we eens kijken naar, laten we erin duiken, dit is wat je moet weten, in deze blog gaan we, in dit artikel bespreek ik.
...
### 27. Gefragmenteerde inleidingen onder koppen

Een kop die direct gevolgd wordt door een nietszeggende eerste zin.
...
AI vertaalt Engelse uitdrukkingen letterlijk. Klinkt onnatuurlijk voor moedertaalsprekers.

**Signaalwoorden:** adresseren (i.p.v. aanpakken), impactvol, leveren/deliveren, het grotere plaatje, in de driver's seat, key takeaways, alignment, performen, leveragen, scalen, uitrollen (in figuurlijke zin overdreven gebruikt).
...
Veel termen zijn ingeburgerd ("team", "manager", "feedback") en hoef je niet te vertalen. Andere zijn pure jargon-import:

* stakeholders → belanghebbenden, betrokkenen
* deliverables → opleverpunten, resultaten
* alignment → afstemming
* bandwidth (figuurlijk) → ruimte, capaciteit
* ownership (figuurlijk) → eigenaarschap, verantwoordelijkheid
* commitment → toezegging, betrokkenheid
* leverage (werkwoord) → benutten, inzetten

Vervang als de NL-versie even helder is. Behoud als de Engelse term een vakterm met eigen betekenis is.
...
### 33. Overdreven formeel register

AI schrijft standaard in ambtelijk jargon, ook als de context dat niet vraagt.

**Signaalwoorden:** derhalve, aldus (als bijwoord), desalniettemin, onderhavig, dient opgemerkt te worden, in het kader van, met betrekking tot, alvorens.
...
**Voor:** "De medewerkers welke deelnemen..."
**Na:** "De medewerkers die deelnemen..."

### 35. "Middels" en officialese-voorzetsels

* "middels" → "via", "met", "door"
* "alvorens" → "voordat"
* "doch" → "maar"
* "immer" → "altijd"
* "thans" → "nu"

**Voor:** "Middels deze brief delen wij u mede dat..."
**Na:** "Met deze brief laten we weten dat..."

### 36. "Men" waar "je" of "we" hoort

"Men" voelt voor moderne Nederlanders als afstandelijk en oubollig. Vervang door "je", "we" of een concrete actor.

**Voor:** "Men kan stellen dat dit beleid effectief is."
**Na:** "Je kunt zeggen dat dit beleid werkt." *of* "Het beleid werkt."

### 37. "Echter" mid-zin als komma-vulling
...
Maximaal één zwaar verbindingswoord per drie alinea's. Wissel af met "ook", "en", of begin gewoon een nieuwe zin.

### 39. Onnatuurlijk "er"-gebruik
...
**Signaalwoorden:** In een wereld waarin..., In tijden van..., In het huidige (digitale/snel veranderende) tijdperk..., Stel je voor dat..., Of het nu gaat om X of Y.
...
### 41. Bijvoeglijk-naamwoord-stapeling

Drie of meer adjectieven achter elkaar maken een zin holler, niet rijker. Kies één.
...
### 42. Vage opsomming-terminators

**Signaalwoorden:** "en meer", "et cetera" (als afsluiting van vage opsomming), "onder andere... en meer", "...en zo".

**Voor:** "De tool ondersteunt rapportages, dashboards, integraties en meer."
**Na:** "De tool maakt rapportages, dashboards en integraties met Slack en HubSpot." *(Wees specifiek of laat de opsomming eindigen.)*

### 43. Datum- en cijfer-format

NL-conventie:

* **Decimaal**: komma, niet punt → "€3,14" niet "€3.14".
* **Duizendtallen**: punt of spatie → "1.000" of "1 000".
* **Datum**: dag-maand-jaar → "15 januari 2024" niet "January 15, 2024" of "1/15/2024".
* **Tijden**: 24-uurs of "uur"-notatie gebruikelijk → "14:30" of "half drie 's middags".
* **Maandnamen**: kleine letter → "januari", niet "Januari".

Controleer datums en getallen in vertaalde of AI-gegenereerde tekst altijd.

### 44. Meta-verwijzingen

**Signaalwoorden:** zoals eerder genoemd, zoals hierboven beschreven, in voorgaande sectie, zoals we hebben gezien.

In korte tekst overbodig. Verwijs alleen meta als de lezer écht terug moet bladeren.

**Voor:** "Zoals eerder genoemd is de planning krap."
**Na:** "De planning is krap." *(De lezer las het net. Niet herhalen.)*
